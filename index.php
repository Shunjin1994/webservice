...
$price_range = (!empty($_GET['price_range'])) ? $_GET['price_range'] : '';
...
// DBから商品データを取得
$dbProductData = getProductList($currentMinNum, $category, $sort, $price_range);
// DBからカテゴリデータを取得
    ...
    <div id="contents" class="site-width">
      ...
      <section id="sidebar">
        <form name="" method="get">
          ...
          <h1 class="title">値段</h1>
          <div class="selectbox">
            <span class="icn_select"></span>
            <select name="price_range">
              <option value="0" <?php if(getFormData('price_range',true) == 0 ){ echo 'selected'; } ?> >選択してください</option> 
              <option value="1" <?php if(getFormData('price_range',true) == 1 ){ echo 'selected'; } ?> >0-1500円</option>
              <option value="2" <?php if(getFormData('price_range',true) == 2 ){ echo 'selected'; } ?> >1500-3000円</option>
              <option value="3" <?php if(getFormData('price_range',true) == 3 ){ echo 'selected'; } ?> >3000-5000円</option>
              <option value="4" <?php if(getFormData('price_range',true) == 4 ){ echo 'selected'; } ?> >5000-10000円</option>
              <option value="5" <?php if(getFormData('price_range',true) == 5 ){ echo 'selected'; } ?> >10000円以上</option>
            </select>
          </div>
